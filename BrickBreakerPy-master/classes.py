# -*- coding: utf-8 -*-
"""
Created on Thu Apr 22 14:13:20 2021
...
class Ball(pygame.sprite.Sprite):
    def __init__(self,p,w,c,pu):
        ...
        while self.hit_powerup == True:
            self.image=pygame.image.load("lightningball.pn")
    ...
    def hit_powerup(self):
        hits=pygame.sprite.spritecollide(self.pu,balls,False)
        if hits: 
            return True
        else:
            return False
...
class Walls(pygame.sprite.Sprite):          #### w variable
    def __init__(self,x,y):
        super().__init__()
